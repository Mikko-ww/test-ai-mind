...
- **max_retries**: Legacy retry count (default: 2)
...
- **requirement.output_file**: Filename for requirement document
- **requirement.timeout_minutes**: Timeout for requirement generation
...
3. **Edit the template**:
   ...
   - Preserve `Agent-Parent-Issue` and `Agent-Task-Id` markers
