...
`Agent-Phase` is deprecated and not used by routing.
...
4. System creates task issues and starts dispatching tasks to Copilot.
5. Review task PRs based on risk level rules.
...
- Verify PR body includes `Agent-Task-Id: spec`.
